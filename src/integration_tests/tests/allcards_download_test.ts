...
export default class AllCardsDownloadTest extends IntegrationTest {
  name(): string {
    return "AllCardsDownloadTest";
  }

  async run(_params: RunParams): Promise<void> {
    ...
    Assert.notEquals(dataInfo, null);
    if (dataInfo === null){
      return;
    }

    // Verify the change/update dates are all empty, because no updates have been completed yet.
    Assert.equals(dataInfo.allCardsChangeDate, "");
    Assert.equals(dataInfo.allCardsUpdateDate, "");
    Assert.equals(dataInfo.dataMapsChangeDate, "");
    Assert.equals(dataInfo.dataMapsUpdateDate, "");

    // Verify that the next change date was pulled from the bulk data listing.
    Assert.equals(dataInfo.allCardsNextChangeDate, "2021-07-07T22:07:49.712+00:00");

    // Verify that the AllCards file and data maps related properties are empty.
    Assert.equals(dataInfo.allCardsS3Date, "");
    Assert.equals(dataInfo.allCardsUpdateInProgress, false);
    Assert.equals(dataInfo.dataMapsUpdateInProgress, false);
    Assert.equals(await getAllCardsFileProgress(services), 0);
    ...
    Assert.equals(dataInfo.allCardsChangeDate, "2021-07-07 22:07:49 UTC");
    Assert.equals(dataInfo.allCardsUpdateDate, "2021-01-01 11:00:00 UTC");
    ...
    // Verify that the AllCards file and data maps related properties are empty.
    Assert.equals(dataInfo.allCardsS3Date, "Fri Jan 01 2021 05:00:00 GMT-0600 (Central Standard Time)");
    Assert.equals(dataInfo.allCardsUpdateInProgress, false);
    Assert.equals(dataInfo.dataMapsUpdateInProgress, false);
    ...
    // Verify that the data map related dates are still empty.
    Assert.equals(dataInfo.dataMapsChangeDate, "2021-07-08 03:07:49 UTC");
    Assert.equals(dataInfo.dataMapsUpdateDate, "2021-01-01 11:00:00 UTC");
    ...
    Assert.equals(IDToName["10001111-2222-3333-4444-555566667777"], "Kanye West");
    Assert.equals(IDToName["20001111-2222-3333-4444-555566667777"], "Kanye North");
    Assert.equals(IDToName["30001111-2222-3333-4444-555566667777"], "Kanye East");
    Assert.equals(IDToName["40001111-2222-3333-4444-555566667777"], "Kanye South");
    Assert.equals(typeof IDToName["50001111-2222-3333-4444-555566667777"], "undefined");
    ...
    Assert.equals(NameToID["Kanye West"][0], "10001111-2222-3333-4444-555566667777");
    Assert.equals(NameToID["Kanye North"][0], "20001111-2222-3333-4444-555566667777");
    Assert.equals(NameToID["Kanye East"][0], "30001111-2222-3333-4444-555566667777");
    Assert.equals(NameToID["Kanye South"][0], "40001111-2222-3333-4444-555566667777");
  }
}
